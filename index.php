...
<body>
	<div class="modal fade" id="addIncome" tabindex="-1" aria-labelledby="addIncomeLabel" aria-hidden="true" data-backdrop="static">
	...
	<div class="modal fade" id="addExpenses" tabindex="-1" aria-labelledby="addExpensesLabel" aria-hidden="true" data-backdrop="static">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
	...
	<div class="wrapper">
		<div class="top-bar">
			...
			<button type="button" class="filter" data-toggle="modal" data-target="#filters">
		...
		<div class="bottom-bar">
			<div class="icons table" id="income">
				<img src="assets/icons/input-24px.svg" alt="Incomes" />
				<p>Incomes</p>
			</div>
			<div class="icons active table" id="expence">
				<img src="assets/icons/payment-24px.svg" alt="Expences" />
				<p>Expenses</p>
			</div>
			<div class="icons" id="setting">
				<img src="assets/icons/settings-24px.svg" alt="Incomes" />
				<p>Settings</p>
			</div>
		</div>
		<div class="buttons tables">
			<button type="button" data-toggle="modal" data-target="#addIncome" class="button">
				Add Incomes
			</button>
			<button type="button" data-toggle="modal" data-target="#addExpenses" class="button">
				Add Expenses
			</button>
		</div>
		<br />
	...
	<script>
		...
		$(".table").click(function() {
			...
			$(".tables").removeClass("display-none");
